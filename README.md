...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/Samuel-ssf/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/Samuel-ssf/conta_bancaria
```
